...
def process_homey_pdf(file_bytes):
    ...
    for i, page in enumerate(reader.pages):
        ...
        # 🌟 保健食品 / Pet 要行專屬 layout(要放喺 "food" 之前判斷)
        if "保健食品" in excel_label or "health_food" in excel_label_lower:
            final_label = "保健食品"
        elif excel_label_lower.strip() == "pet" or "pet food" in excel_label_lower or "pet_food" in excel_label_lower:
            final_label = "Pet"
